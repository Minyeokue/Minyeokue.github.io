...
last_modified_at: 2024-10-01 16:51:26 +0900
categories: [Project]
...
프로젝트명은 *티켓 예매 서비스 확장을 위한 **하이브리드 클라우드 환경 설계 및 구축***입니다. 프로젝트에서 사용한 소프트웨어 스택입니다.

![프로젝트 소프트웨어 스택](/assets/img/2024-09-27/1.svg)
_프로젝트 소프트웨어 스택_
...
![온프레미스 쿠버네티스 아키텍처](/assets/img/2024-09-27/2.png)
_온프레미스 쿠버네티스 아키텍처_

<br>

쿠버네티스 솔루션 이후 프로젝트 시나리오에서 급격한 트래픽으로 인해 다운타임이 발생하였고, 다운타임 재발 방지를 위해 온프레미스 쿠버네티스에서 **AWS EKS로 마이그레이션을 결정**하였습니다.
...
![하이브리드 클라우드 아키텍처](/assets/img/2024-09-27/3.svg)
_하이브리드 클라우드 아키텍처_

<br>

AWS의 대부분의 리소스는 Terraform을 통해 프로비저닝하였으며 상세 정보는 `.tfstate`{:filepath}에 저장됩니다. **온프레미스의 DB 클러스터를 유지하겠다는 결정**에 따라 **AWS Site-to-Site VPN을 활용해 온프레미스와 AWS VPC를 연결**합니다.
...
![CI/CD 관리 웹 페이지](/assets/img/2024-09-27/5.png)
_CI/CD 관리 웹 페이지_
...
![시간 불일치 확인](/assets/img/2024-09-27/6.png)
...
![권한 획득 실패](/assets/img/2024-09-27/7.png)
_권한 획득 실패_
...
![클러스터 생성 권한 필수 설정](/assets/img/2024-09-27/8.png)
_클러스터 생성 권한 필수 설정_
...
![VPN Gateway 미연결](/assets/img/2024-09-27/9.png)
_VPN Gateway 미연결_
...
![VPN 필수 설정](/assets/img/2024-09-27/10.png)
_VPN 필수 설정_
...
![Attachment](/assets/img/2024-09-27/11.png)
_Attachment_
